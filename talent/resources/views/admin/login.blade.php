    ...
    <div class="splash-container">
        <div class="card ">
            <div class="card-header text-center">
                <span style="color: #FE6701;font-size: 41px; font-family: initial;">
                    <a style="color: #FE6701">
                        Jordanian Talent
                    </a>
                </span>
            ...
            <div class="card-body">
                ...
                <form action="loginAdmin" method="POST">
                    ...
                    <button type="submit" class="btn btn-primary btn-lg btn-block" style="background: #FE6701">Sign in</button>
                </form>
            </div>
        </div>
    </div>
